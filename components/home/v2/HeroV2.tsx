...
export default function HeroV2() {
  const { t } = useApp();
  return (
    <section className="relative" style={{ paddingTop: 56, paddingBottom: 96 }}>
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={1}>
              <h1 className="t-display">
                {t("h_hero_t1")}<br />
                {t("h_hero_t2")} {t("h_hero_em")}
              </h1>
            </Reveal>

            <Reveal delay={2}>
              <p className="t-lead" style={{ marginTop: 28, maxWidth: 560 }}>
            ...
            <Reveal delay={4}>
              ...
              >
                <MetricInline value="8" label={t("h_hero_m1")} />
                <MetricInline value="3.5s" label={t("h_hero_m2")} />
                <MetricInline value="0" label={t("h_hero_m3")} />
